    ...
    <section class="mt-10">
        <form action="/student/{{$student->id}}" method="POST" class="flex flex-col" enctype="multipart/form-data">
            ...
            <div class="flex justify-center items-center my-4">
                @php $default_profile = "https://api.dicebear.com/9.x/initials/svg?seed=".$student->first_name @endphp
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="text" name="first_name" class="bg-gray-200 rounded w-full
                text-gray-700 focus:outline-none border-b-4 border-gray-400
                px-3" value={{$student->first_name}}>
                @error('first_name')
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="text" name="last_name" class="bg-gray-200 rounded w-full
                text-gray-700 focus:outline-none border-b-4 border-gray-400
                px-3 " value={{$student->last_name}}>
                @error('last_name')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <select name="gender" class="bg-gray-200 rounded w-full
                text-gray-700 focus:outline-none border-b-4 border-gray-400
                px-3">
            ...
            <div class="mb-6 pt-3 rounded bg-gray-200">
                ...
                <input type="file" name="student_image" class="bg-gray-200 rounded w-full
                text-gray-700 focus:outline-none border-b-4 border-gray-400
                px-3" value={{$student->student_image}}>
                @error('student_image')
                    <p class="text-red-500 text-xs p-1">
                        {{$message}}
                    </p>
        ...
        <form action="/student/{{$student->id}}" method="POST">
            ...
            <button type="submit" class="mt-2 bg-red-600 w-full hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">
                Delete
            </button>
        </form>
    </section>
